...
// CAUTION: The jesfit function is the same as in drawFracs.h
...
public:
  ...
  *  "HW" (Herwig, for mc vs mc) */
  TrigFracs(const char *mc_path, const char *dt_path, string plot_title, string savedir, string mc_type = "MC", string dt_type = "RunG") {
