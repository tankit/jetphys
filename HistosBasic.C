...
HistosBasic::HistosBasic(TDirectory *dir, string trigname, double etamin, double etamax,
  ...
  pmpf_ptave_unc0    = new TProfile("pmpf_ptave_unc0",";p_{T,ave} (GeV);R_{MPFu}",nx,&x[0]);
  pmpf_ptave_one0   = new TProfile("pmpf_ptave_one0",";p_{T,ave} (GeV);R_{MPF1}",nx,&x[0]);
  pmpf_ptave_n0     = new TProfile("pmpf_ptave_n0",";p_{T,ave} (GeV);R_{MPFn}",nx,&x[0]);
  pmpf_ptave_unc1    = new TProfile("pmpf_ptave_unc1",";p_{T,ave} (GeV);R_{MPFu}",nx,&x[0]);
  pmpf_ptave_one1   = new TProfile("pmpf_ptave_one1",";p_{T,ave} (GeV);R_{MPF1}",nx,&x[0]);
  pmpf_ptave_n1     = new TProfile("pmpf_ptave_n1",";p_{T,ave} (GeV);R_{MPFn}",nx,&x[0]);
  pmpf_ptave_unc     = new TProfile("pmpf_ptave_unc",";p_{T,ave} (GeV);R_{MPFu}",nx,&x[0]);
  pmpf_ptave_one    = new TProfile("pmpf_ptave_one",";p_{T,ave} (GeV);R_{MPF1}",nx,&x[0]);
  pmpf_ptave_n      = new TProfile("pmpf_ptave_n",";p_{T,ave} (GeV);R_{MPFn}",nx,&x[0]);

  pmpfinv_ptave_unc0  = new TProfile("pmpfinv_ptave_unc0",";p_{T,ave} (GeV);R_{MPFu}",nx,&x[0]);
  pmpfinv_ptave_one0 = new TProfile("pmpfinv_ptave_one0",";p_{T,ave} (GeV);R_{MPF1}",nx,&x[0]);
  pmpfinv_ptave_n0   = new TProfile("pmpfinv_ptave_n0",";p_{T,ave} (GeV);R_{MPFn}",nx,&x[0]);
  pmpfinv_ptave_unc1  = new TProfile("pmpfinv_ptave_unc1",";p_{T,ave} (GeV);R_{MPFu}",nx,&x[0]);
  pmpfinv_ptave_one1 = new TProfile("pmpfinv_ptave_one1",";p_{T,ave} (GeV);R_{MPF1}",nx,&x[0]);
  pmpfinv_ptave_n1   = new TProfile("pmpfinv_ptave_n1",";p_{T,ave} (GeV);R_{MPFn}",nx,&x[0]);
  pmpfinv_ptave_unc   = new TProfile("pmpfinv_ptave_unc",";p_{T,ave} (GeV);R_{MPFu}",nx,&x[0]);
  pmpfinv_ptave_one  = new TProfile("pmpfinv_ptave_one",";p_{T,ave} (GeV);R_{MPF1}",nx,&x[0]);
  pmpfinv_ptave_n    = new TProfile("pmpfinv_ptave_n",";p_{T,ave} (GeV);R_{MPFn}",nx,&x[0]);
  ...
  h2mpf_ptave_unc0    = new TH2D("h2mpf_ptave_unc0",";p_{T,ave} (GeV);R_{MPFu}",nx,&x[0],100,-4,6);
  h2mpf_ptave_one0   = new TH2D("h2mpf_ptave_one0",";p_{T,ave} (GeV);R_{MPF1}",nx,&x[0],100,-4,6);
  h2mpf_ptave_n0     = new TH2D("h2mpf_ptave_n0",";p_{T,ave} (GeV);R_{MPFn}",nx,&x[0],100,-4,6);
  h2mpf_ptave_unc1    = new TH2D("h2mpf_ptave_unc1",";p_{T,ave} (GeV);R_{MPFu}",nx,&x[0],100,-4,6);
  h2mpf_ptave_one1   = new TH2D("h2mpf_ptave_one1",";p_{T,ave} (GeV);R_{MPF1}",nx,&x[0],100,-4,6);
  h2mpf_ptave_n1     = new TH2D("h2mpf_ptave_n1",";p_{T,ave} (GeV);R_{MPFn}",nx,&x[0],100,-4,6);
  h2mpf_ptave_unc     = new TH2D("h2mpf_ptave_unc",";p_{T,ave} (GeV);R_{MPFu}",nx,&x[0],100,-4,6);
  h2mpf_ptave_one    = new TH2D("h2mpf_ptave_one",";p_{T,ave} (GeV);R_{MPF1}",nx,&x[0],100,-4,6);
  h2mpf_ptave_n      = new TH2D("h2mpf_ptave_n",";p_{T,ave} (GeV);R_{MPFn}",nx,&x[0],100,-4,6);

  h2mpfinv_ptave_unc0  = new TH2D("h2mpfinv_ptave_unc0",";p_{T,ave} (GeV);R_{MPFu}",nx,&x[0],100,-4,6);
  h2mpfinv_ptave_one0 = new TH2D("h2mpfinv_ptave_one0",";p_{T,ave} (GeV);R_{MPF1}",nx,&x[0],100,-4,6);
  h2mpfinv_ptave_n0   = new TH2D("h2mpfinv_ptave_n0",";p_{T,ave} (GeV);R_{MPFn}",nx,&x[0],100,-4,6);
  h2mpfinv_ptave_unc1  = new TH2D("h2mpfinv_ptave_unc1",";p_{T,ave} (GeV);R_{MPFu}",nx,&x[0],100,-4,6);
  h2mpfinv_ptave_one1 = new TH2D("h2mpfinv_ptave_one1",";p_{T,ave} (GeV);R_{MPF1}",nx,&x[0],100,-4,6);
  h2mpfinv_ptave_n1   = new TH2D("h2mpfinv_ptave_n1",";p_{T,ave} (GeV);R_{MPFn}",nx,&x[0],100,-4,6);
  h2mpfinv_ptave_unc   = new TH2D("h2mpfinv_ptave_unc",";p_{T,ave} (GeV);R_{MPFu}",nx,&x[0],100,-4,6);
  h2mpfinv_ptave_one  = new TH2D("h2mpfinv_ptave_one",";p_{T,ave} (GeV);R_{MPF1}",nx,&x[0],100,-4,6);
  h2mpfinv_ptave_n    = new TH2D("h2mpfinv_ptave_n",";p_{T,ave} (GeV);R_{MPFn}",nx,&x[0],100,-4,6);

  hleadmpf_unc0          = new TH1D("hleadmpf_unc0","",100,-100,100);
  hleadmpf_unc1          = new TH1D("hleadmpf_unc1","",100,-100,100);
  hleadmpf_unc           = new TH1D("hleadmpf_unc","",100,-100,100);
  ...
  //hleadmpftp_unc0       = new TH1D("hleadmpftp_unc0",";p_{T,leading} (GeV);MPF_{u}",100,-3.,3.);
  //hleadmpftp_unc1       = new TH1D("hleadmpftp_unc1",";p_{T,leading} (GeV);MPF_{u}",100,-3.,3.);
  //hleadmpftp_unc        = new TH1D("hleadmpftp_unc",";p_{T,leading} (GeV);MPF_{u}",100,-3.,3.);
  //hleadmpftp_one0       = new TH1D("hleadmpftp_one0",";p_{T,leading} (GeV);MPF_{1};",100,-3.,3.);
  //hleadmpftp_one1       = new TH1D("hleadmpftp_one1",";p_{T,leading} (GeV);MPF_{1};",100,-3.,3.);
  //hleadmpftp_one        = new TH1D("hleadmpftp_one",";p_{T,leading} (GeV);MPF_{1};",100,-3.,3.);
  //hleadmpftp_n0         = new TH1D("hleadmpftp_n0",";p_{T,leading} (GeV);MPF_{n};",100,-3.,3.);
  //hleadmpftp_n1         = new TH1D("hleadmpftp_n1",";p_{T,leading} (GeV);MPF_{n};",100,-3.,3.);
  //hleadmpftp_n          = new TH1D("hleadmpftp_n",";p_{T,leading} (GeV);MPF_{n};",100,-3.,3.);

  pmpflead_leading_unc0  = new TProfile("pmpflead_leading_unc0",";p_{T,leading} (GeV);MPF_{u}",nx,&x[0]);
  ...
  pmpflead_leading_unc1  = new TProfile("pmpflead_leading_unc1",";p_{T,leading} (GeV);MPF_{u}",nx,&x[0]);
  ...
  pmpflead_leading_unc   = new TProfile("pmpflead_leading_unc",";p_{T,leading} (GeV);MPF_{u}",nx,&x[0]);
  ...
  h2mpflead_leading_unc0  = new TH2D("h2mpflead_leading_unc0",";p_{T,leading} (GeV);MPF_{u}",nx,&x[0],100,-5,5);
  ...
  h2mpflead_leading_unc1  = new TH2D("h2mpflead_leading_unc1",";p_{T,leading} (GeV);MPF_{u}",nx,&x[0],100,-5,5);
  ...
  h2mpflead_leading_unc   = new TH2D("h2mpflead_leading_unc",";p_{T,leading} (GeV);MPF_{u}",nx,&x[0],100,-5,5);
  ...
  pmpf_recoil_unc0  = new TProfile("pmpf_recoil_unc0",";p_{T,recoil} (GeV);MPF_{u}",nx,&x[0]);
  pmpf_recoil_one0 = new TProfile("pmpf_recoil_one0",";p_{T,recoil} (GeV);1 - MPF_{1}",nx,&x[0]);
  pmpf_recoil_n0   = new TProfile("pmpf_recoil_n0",";p_{T,recoil} (GeV);MPF_{n}",nx,&x[0]);
  pmpf_recoil_unc1  = new TProfile("pmpf_recoil_unc1",";p_{T,recoil} (GeV);MPF_{u}",nx,&x[0]);
  pmpf_recoil_one1 = new TProfile("pmpf_recoil_one1",";p_{T,recoil} (GeV);1 - MPF_{1}",nx,&x[0]);
  pmpf_recoil_n1   = new TProfile("pmpf_recoil_n1",";p_{T,recoil} (GeV);MPF_{n}",nx,&x[0]);
  pmpf_recoil_unc   = new TProfile("pmpf_recoil_unc",";p_{T,recoil} (GeV);MPF_{u}",nx,&x[0]);
  pmpf_recoil_one  = new TProfile("pmpf_recoil_one",";p_{T,recoil} (GeV);1 - MPF_{1}",nx,&x[0]);
  pmpf_recoil_n    = new TProfile("pmpf_recoil_n",";p_{T,recoil} (GeV);MPF_{n}",nx,&x[0]);

  h2mpf_recoil_unc0  = new TH2D("h2mpf_recoil_unc0",";p_{T,recoil} (GeV);MPF_{u}",nx,&x[0],100,-5,5);
  h2mpf_recoil_one0 = new TH2D("h2mpf_recoil_one0",";p_{T,recoil} (GeV);1 - MPF_{1}",nx,&x[0],100,-5,5);
  h2mpf_recoil_n0   = new TH2D("h2mpf_recoil_n0",";p_{T,recoil} (GeV);MPF_{n}",nx,&x[0],100,-5,5);
  h2mpf_recoil_unc1  = new TH2D("h2mpf_recoil_unc1",";p_{T,recoil} (GeV);MPF_{u}",nx,&x[0],100,-5,5);
  h2mpf_recoil_one1 = new TH2D("h2mpf_recoil_one1",";p_{T,recoil} (GeV);1 - MPF_{1}",nx,&x[0],100,-5,5);
  h2mpf_recoil_n1   = new TH2D("h2mpf_recoil_n1",";p_{T,recoil} (GeV);MPF_{n}",nx,&x[0],100,-5,5);
  h2mpf_recoil_unc   = new TH2D("h2mpf_recoil_unc",";p_{T,recoil} (GeV);MPF_{u}",nx,&x[0],100,-5,5);
  h2mpf_recoil_one  = new TH2D("h2mpf_recoil_one",";p_{T,recoil} (GeV);1 - MPF_{1}",nx,&x[0],100,-5,5);
  h2mpf_recoil_n    = new TH2D("h2mpf_recoil_n",";p_{T,recoil} (GeV);MPF_{n}",nx,&x[0],100,-5,5);
