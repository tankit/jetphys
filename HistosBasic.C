...
HistosBasic::HistosBasic(TDirectory *dir, string trigname, double etamin, double etamax,
  ...
  pmpf_ptave_unc0    = new TProfile("pmpf_ptave_unc0",";p_{T,ave} (GeV);R_{MPF_unc}",nx,&x[0]);
  ...
  pmpf_ptave_unc1    = new TProfile("pmpf_ptave_unc1",";p_{T,ave} (GeV);R_{MPF_unc}",nx,&x[0]);
  ...
  pmpf_ptave_unc     = new TProfile("pmpf_ptave_unc",";p_{T,ave} (GeV);R_{MPF_unc}",nx,&x[0]);
  ...
  pmpfinv_ptave_unc0  = new TProfile("pmpfinv_ptave_unc0",";p_{T,ave} (GeV);R_{MPF_unc}",nx,&x[0]);
  ...
  pmpfinv_ptave_unc1  = new TProfile("pmpfinv_ptave_unc1",";p_{T,ave} (GeV);R_{MPF_unc}",nx,&x[0]);
  ...
  pmpfinv_ptave_unc   = new TProfile("pmpfinv_ptave_unc",";p_{T,ave} (GeV);R_{MPF_unc}",nx,&x[0]);
  ...
  h2mpf_ptave_unc0    = new TH2D("h2mpf_ptave_unc0",";p_{T,ave} (GeV);R_{MPF_unc}",nx,&x[0],100,-4,6);
  ...
  h2mpf_ptave_unc1    = new TH2D("h2mpf_ptave_unc1",";p_{T,ave} (GeV);R_{MPF_unc}",nx,&x[0],100,-4,6);
  ...
  h2mpf_ptave_unc     = new TH2D("h2mpf_ptave_unc",";p_{T,ave} (GeV);R_{MPF_unc}",nx,&x[0],100,-4,6);
  ...
  h2mpfinv_ptave_unc0  = new TH2D("h2mpfinv_ptave_unc0",";p_{T,ave} (GeV);R_{MPF_unc}",nx,&x[0],100,-4,6);
  ...
  h2mpfinv_ptave_unc1  = new TH2D("h2mpfinv_ptave_unc1",";p_{T,ave} (GeV);R_{MPF_unc}",nx,&x[0],100,-4,6);
  ...
  h2mpfinv_ptave_unc   = new TH2D("h2mpfinv_ptave_unc",";p_{T,ave} (GeV);R_{MPF_unc}",nx,&x[0],100,-4,6);
  ...
  //hleadmpftp_unc0        = new TH1D("hleadmpftp_unc0",";MPF(ue,leading);",100,-3.,3.);
  //hleadmpftp_unc1        = new TH1D("hleadmpftp_unc1",";MPF(ue,leading);",100,-3.,3.);
  //hleadmpftp_unc         = new TH1D("hleadmpftp_unc",";MPF(ue,leading);",100,-3.,3.);
  ...
  pmpflead_leading_unc0  = new TProfile("pmpflead_leading_unc0",";p_{T,leading} (GeV);MPF_{ue}",nx,&x[0]);
  ...
  pmpflead_leading_unc1  = new TProfile("pmpflead_leading_unc1",";p_{T,leading} (GeV);MPF_{ue}",nx,&x[0]);
  ...
  pmpflead_leading_unc   = new TProfile("pmpflead_leading_unc",";p_{T,leading} (GeV);MPF_{ue}",nx,&x[0]);
  ...
  h2mpflead_leading_unc0  = new TH2D("h2mpflead_leading_unc0",";p_{T,leading} (GeV);MPF_{ue}",nx,&x[0],100,-5,5);
  ...
  h2mpflead_leading_unc1  = new TH2D("h2mpflead_leading_unc1",";p_{T,leading} (GeV);MPF_{ue}",nx,&x[0],100,-5,5);
  ...
  h2mpflead_leading_unc   = new TH2D("h2mpflead_leading_unc",";p_{T,leading} (GeV);MPF_{ue}",nx,&x[0],100,-5,5);
  ...
  pmpf_recoil_unc0  = new TProfile("pmpf_recoil_unc0",";p_{T,recoil} (GeV);MPF_{ue}",nx,&x[0]);
  ...
  pmpf_recoil_unc1  = new TProfile("pmpf_recoil_unc1",";p_{T,recoil} (GeV);MPF_{ue}",nx,&x[0]);
  ...
  pmpf_recoil_unc   = new TProfile("pmpf_recoil_unc",";p_{T,recoil} (GeV);MPF_{ue}",nx,&x[0]);
  ...
  h2mpf_recoil_unc0  = new TH2D("h2mpf_recoil_unc0",";p_{T,recoil} (GeV);MPF_{ue}",nx,&x[0],100,-5,5);
  ...
  h2mpf_recoil_unc1  = new TH2D("h2mpf_recoil_unc1",";p_{T,recoil} (GeV);MPF_{ue}",nx,&x[0],100,-5,5);
  ...
  h2mpf_recoil_unc   = new TH2D("h2mpf_recoil_unc",";p_{T,recoil} (GeV);MPF_{ue}",nx,&x[0],100,-5,5);
