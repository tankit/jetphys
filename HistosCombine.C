...
void HistosCombine(string type = "") {
  ...
  recurseCombFile(fin, fout, isdt, "pmpfleadinv_leading_ue");
  ...
  recurseCombFile(fin, fout, isdt, "pmpfleadinv_leading_ue1");
  ...
  recurseCombFile(fin, fout, isdt, "pmpfleadinv_leading_ue0");
  ...
  recurseCombFile(fin, fout, isdt, "h2mpfleadinv_leading_ue");
  ...
  recurseCombFile(fin, fout, isdt, "h2mpfleadinv_leading_ue1");
  ...
  recurseCombFile(fin, fout, isdt, "h2mpfleadinv_leading_ue0");
