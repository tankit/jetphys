...
void HistosCombine(string type = "") {
  ...
  recurseCombFile(fin, fout, isdt, "pmpflead_leading_ue");
  ...
  recurseCombFile(fin, fout, isdt, "pmpflead_leading_ue1");
  ...
  recurseCombFile(fin, fout, isdt, "pmpflead_leading_ue0");
  ...
  recurseCombFile(fin, fout, isdt, "h2mpflead_leading_ue");
  ...
  recurseCombFile(fin, fout, isdt, "h2mpflead_leading_ue1");
  ...
  recurseCombFile(fin, fout, isdt, "h2mpflead_leading_ue0");
