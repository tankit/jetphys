...
double vx[neta][nbins] =
  ...
  pdjmass0_ptratio = new TProfile("pdjmass0_ptratio","",int(_jp_sqrts),0.,_jp_sqrts);
  //hdjmass->Sumw2();
  //hdjmass0->Sumw2();
  ...
  pncand = new TProfile("pncand","",nx,&x[0]);
  pnch = new TProfile("pnch","",nx,&x[0]);
  pnne = new TProfile("pnne","",nx,&x[0]);
  pnnh = new TProfile("pnnh","",nx,&x[0]);
  pnce = new TProfile("pnce","",nx,&x[0]);
  pnmu = new TProfile("pnmu","",nx,&x[0]);
  pchf = new TProfile("pchf","",nx,&x[0]);
  pnef = new TProfile("pnef","",nx,&x[0]);
  pnhf = new TProfile("pnhf","",nx,&x[0]);
  pcef = new TProfile("pcef","",nx,&x[0]);
  pmuf = new TProfile("pmuf","",nx,&x[0]);
  pbeta = new TProfile("pbeta","",nx,&x[0]);
  pbetastar = new TProfile("pbetastar","",nx,&x[0]);
  pak4ak8_50 = (ak4ak8 ? new TProfile("pak4ak8_50","",nx,&x[0]) : 0);
  pak4ak8_25 = (ak4ak8 ? new TProfile("pak4ak8_25","",nx,&x[0]) : 0);
  ...
  pncandtp = new TProfile("pncandtp","",nx,&x[0]);
  pnchtp = new TProfile("pnchtp","",nx,&x[0]);
  pnnetp = new TProfile("pnnetp","",nx,&x[0]);
  pnnhtp = new TProfile("pnnhtp","",nx,&x[0]);
  pncetp = new TProfile("pncetp","",nx,&x[0]);
  pnmutp = new TProfile("pnmutp","",nx,&x[0]);
  pchftp = new TProfile("pchftp","",nx,&x[0]);
  pneftp = new TProfile("pneftp","",nx,&x[0]);
  pnhftp = new TProfile("pnhftp","",nx,&x[0]);
  pceftp = new TProfile("pceftp","",nx,&x[0]);
  pmuftp = new TProfile("pmuftp","",nx,&x[0]);
  pbetatp = new TProfile("pbetatp","",nx,&x[0]);
  pbetastartp = new TProfile("pbetastartp","",nx,&x[0]);
  //
  pchftp2 = new TProfile("pchftp2","",nx,&x[0]);
  pneftp2 = new TProfile("pneftp2","",nx,&x[0]);
  pnhftp2 = new TProfile("pnhftp2","",nx,&x[0]);
  pceftp2 = new TProfile("pceftp2","",nx,&x[0]);
  pmuftp2 = new TProfile("pmuftp2","",nx,&x[0]);
  //
  pak4ak8tp_50 = (ak4ak8 ? new TProfile("pak4ak8tp_50","",nx,&x[0]) : 0);
  pak4ak8tp_25 = (ak4ak8 ? new TProfile("pak4ak8tp_25","",nx,&x[0]) : 0);
