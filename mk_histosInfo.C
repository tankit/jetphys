...
void mk_histosInfo() {
  ...
  if (_jp_isdt) {
    ...
    } else if (strings_equal(_jp_run,"RunH16_Han")) {
      const char* ps = "Data/2016/";
    ...
    } else if (strings_equal(_jp_run,"RunFearly16_Gold")) {
      const char* ps = "Data/2016/";
    ...
    } else if (strings_equal(_jp_run,"RunB16_Eng")) {
      const char* ps = "Data/2016/";
    ...
    } else if (strings_equal(_jp_run,"RunC16_Eng")) {
      const char* ps = "Data/2016/";
    ...
    } else if (strings_equal(_jp_run,"RunD16_Eng")) {
      const char* ps = "Data/2016/";
    ...
    } else if (strings_equal(_jp_run,"RunE16_Eng")) {
      const char* ps = "Data/2016/";
    ...
    } else if (strings_equal(_jp_run,"RunFearly16_Eng")) {
      const char* ps = "Data/2016/";
    ...
    } else if (strings_equal(_jp_run,"RunFlate16_Eng")) {
      const char* ps = "Data/2016/";
      files.push_back(Form("%s%sNtuples-Data-2016RunFlate-LegacyReReco-80Xpart1.root",p,ps));
    } else if (strings_equal(_jp_run,"RunG16_Eng")) {
      const char* ps = "Data/2016/";
    ...
    } else if (strings_equal(_jp_run,"RunH16_Eng")) {
      const char* ps = "Data/2016/";
